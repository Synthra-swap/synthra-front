...
export const MAIN_CARDS = [
  {
    to: '/swap',
    title: 'Swap tokens',
    description: 'Buy, sell, and explore data token on Synthra.',
    cta: 'Trade Tokens',
...
export const MORE_CARDS = [
  ...
  // },
  {
    to: '/pools',
    title: 'Earn',
    description: 'Provide liquidity to pools on Synthra and earn fees on swaps.',
  ...
  },
  {
    ...
    external: true,
    title: 'Build dApps',
    description: 'Build apps and tools on the largest DeFi protocol on Synthra.',
