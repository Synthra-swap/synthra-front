...
const LogoSectionContent = () => {
  return (
    <>
      <SocialLinks>
        <SocialLink href="https://discord.gg/eesEKPRDtd" target="_blank" rel="noopener noreferrer">
          <DiscordIcon size={32} />
        </SocialLink>
        <SocialLink href="https://x.com/Synthra-swap" target="_blank" rel="noopener noreferrer">
          <TwitterIcon size={32} />
        </SocialLink>
        <SocialLink href="https://github.com/Synthra-swap" target="_blank" rel="noopener noreferrer">
          <GithubIcon size={32} />
        </SocialLink>
      </SocialLinks>
    </>
    ...
    <Footer>
      ...
      <FooterLinks>
        ...
        <LinkGroup>
          ...
          <ExternalTextLink href="https://discord.gg/eesEKPRDtd" target="_blank" rel="noopener noreferrer">
            Contact Us On Discord
          </ExternalTextLink>
          <ExternalTextLink href="https://docs.synthra.org">Help Center</ExternalTextLink>
        </LinkGroup>
      </FooterLinks>
