...
const StyledConnectButton = styled.button`
  ...
  border-bottom-right-radius: ${FULL_BORDER_RADIUS}px;
  border-top-right-radius: ${FULL_BORDER_RADIUS}px;
  //background-color accent gradient left black, middle accent2, right black
  background: ${({ theme }) => theme.navbarGradientDark};
  font-weight: 535;
  font-size: 16px;
  padding: 10px 12px;
  color: inherit;
