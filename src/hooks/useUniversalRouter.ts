...
import { SwapRouter, UNIVERSAL_ROUTER_ADDRESS } from '@synthra-swap/universal-router-sdk'
...
export function useUniversalRouterSwapCallback(trade: ClassicTrade | undefined, options: SwapOptions) {
  ...
  return useCallback(async () => {
    try {
      ...
      const tx = {
        from: account,
        to: "0x197EEAd5Fe3DB82c4Cd55C5752Bc87AEdE11f230",
        data,
        // TODO(https://github.com/synthra-swap/universal-router-sdk/issues/113): universal-router-sdk returns a non-hexlified value.
