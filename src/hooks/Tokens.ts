import { ChainId, Currency, Token } from '@synthra-swap/sdk-core'
...
export function useDefaultActiveTokens(chainId: Maybe<ChainId>): { [address: string]: Token } {
  ...
  console.log('useDefaultActiveTokens', { defaultListTokens, chainId })
  const tokensFromMap = useTokensFromMap(defaultListTokens, chainId)
  const userAddedTokens = useUserAddedTokens()
  console.log('useDefaultActiveTokens userAddedTokens', userAddedTokens)
  return useMemo(() => {
    return (
      userAddedTokens
