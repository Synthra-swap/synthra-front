...
const setBackground = (newValues: TargetBackgroundStyles) =>
  ...
  function setDefaultBackground(backgroundRadialGradientElement: HTMLElement, darkMode?: boolean) {
    ...
    //   'radial-gradient(100% 100% at 50% 0%, rgba(97, 20, 241, 0.05) 0%, rgba(246, 66, 220, 0) 100%), #FFFFFF'
  ...
  useEffect(() => {
    ...
    switch (chainId) {
      ...
      case ChainId.UOMI: {
        // setBackground(backgroundResetStyles)
        // const baseLightGradient =
        //   'radial-gradient(100% 100% at 50% 0%, rgba(97, 20, 241, 0.1) 0%, rgba(246, 66, 220, 0.05) 40.0%, rgba(246, 66, 220, 0) 100%), rgb(255, 255, 255)'
        // const baseDarkGradient =
        //   'radial-gradient(100% 100% at 50% 0%, rgba(97, 20, 241, 0.1) 0%, rgba(246, 66, 220, 0.05) 40%, rgba(246, 66, 220, 0) 100%), rgb(13, 14, 14)'
        // backgroundRadialGradientElement.style.background = darkMode ? baseDarkGradient : baseLightGradient
        break
      }
      default: {
