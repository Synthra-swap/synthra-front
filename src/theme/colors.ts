...
export const colors = {
  ...
  accent1_light: '#f642dc',
  accent2_light: '#C6ABD2',
  success: '#40B66B',
  critical: '#FF5F52',
...
const commonTheme = {
 ...
 navbarGradientDark: 'radial-gradient(circle at 50% 10%, rgba(145, 71, 255, 0.4) 0%, rgba(97, 0, 255, 0.2) 35%, rgba(13, 13, 13, 0) 70%), rgb(19, 19, 19)',
navbarGradientLight: 'radial-gradient(circle at 50% 0%, rgba(246, 66, 220, 0.15) 0%, rgba(199, 46, 237, 0.05) 45%, rgba(255, 255, 255, 0) 65%), rgb(249, 249, 249)',

  
  brandedGradient: 'linear-gradient(139.57deg, #6114f1 4.35%, #f642dc 96.44%);',
  promotionalGradient: 'linear-gradient(139.57deg, #6114f1 4.35%, #f642dc 96.44%);',
}
