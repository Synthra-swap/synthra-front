...
import { BigintIsh, ChainId, CurrencyAmount, Token, TradeType } from '@synthra-swap/sdk-core'
...
} from '@synthra-swap/smart-order-router'
...
export function getRouter(chainId: ChainId, web3Provider: Web3Provider | undefined): RouterAndProvider {
  ...
  if (
    ...
    console.log('cached provider router', cachedProviderRouter.routerProvider)
