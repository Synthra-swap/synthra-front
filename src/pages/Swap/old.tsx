...
export const ArrowWrapper = styled.div`
  ...
  // Add a pulsing animation to draw attention to the swap button
  @keyframes pulse {
    0% { box-shadow: 0 0 0 0 rgba(130, 71, 229, 0.4); }
    70% { box-shadow: 0 0 0 6px rgba(130, 71, 229, 0); }
    100% { box-shadow: 0 0 0 0 rgba(130, 71, 229, 0); }
  }
...
export const StyledButtonPrimary = styled(ButtonPrimary as any)`
  ...
  &:not(:disabled):hover {
    ...
    box-shadow: 0 6px 14px rgba(130, 71, 229, 0.3);
  }
...
const SwapSection = styled.div`
  ...
  &:focus-within:before {
    border-color: ${({ theme }) => theme.surface3};
    box-shadow: 0 0 0 1px ${({ theme }) => theme.accent1};
  }
`;
    ...
    <>
      <div 
        ...
        style={{ 
          ...
          borderRadius: '12px',
          marginTop: '8px',
          backgroundColor: isVisible ? 'transparent' : 'transparent',
          transition: 'background-color 0.2s ease'
        }}
      >
        <Text fontSize={14}>Transaction details</Text>
        <animated.div style={{ 
          transform: useSpring({ 
      ...
      >
        <Text fontSize={20}>
          {swapInputError ? (
            ...
            <>
              <LoadingAnimation style={{ display: 'inline-block', width: 20, height: 20, marginRight: 8 }} />
