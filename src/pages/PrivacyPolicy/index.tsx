...
export default function PrivacyPolicy() {
  ...
  return (
    <PageWrapper>
      <Header>
        <Container>
          <Title>Synthra Privacy Policy</Title>
        </Container>
      </Header>
      <AutoColumn gap="md">
        <MarkDownWrapper>
          <ReactMarkdown
            source={`# **Synthra Privacy Policy**

*Last Updated: December 2024*

*This Privacy Policy explains how the Synthra Foundation, its subsidiary, collects, uses, and discloses information about you. This Privacy Policy applies when you use our website, Synthra Protocol user-interface or application and other online products (collectively, our “UI”), engage with us on social media, or otherwise interact with us.*
...
- Synthra does not typically request, collect or use personal information. With the exception of your wallet address, there is no reason for you to provide personal information when you use the UI.
- Synthra does not and has not stored personal information from users of the UI. However, Synthra uses third party services including, without limitation, Cloudflare and Fathom Analytics who may collect and store certain user information only for use in the provision of their services.
- Synthra does not set any cookies. However, it’s possible we may use third party service providers in the future that set cookies.
...
Synthra is not directed to children under the age of 16. If a parent or guardian becomes aware that his or her child has provided us with personal information without your consent, please contact us at synthra-swap@gmail.com. If we become aware that a child under the age of 16 has provided us with personal information, we will take reasonable efforts to delete such personal information.
...
We may derive limited information or draw inferences about you based on the information we have access to or receive, most importantly, from our service providers. Your wallet and IP address is accessible to Synthra and its vendor(s). We may make inferences about you based on your wallet or IP address.
...
- Ensure proper functioning of Synthra and the UI;
...
- Detect, investigate, and prevent security incidents and other malicious, deceptive, fraudulent, or illegal activity and protect the rights and property of Synthra and others;
...
We do not have access to or share personally identifiable information, other than as described herein, in the normal course of Synthra business. However, when Synthra has access to personal information, such as your wallet and certain IP addresses, it may share that information in the following circumstances or as otherwise described in this policy:
...
- We may share personal information if we believe that your actions are inconsistent with our user agreements or policies, if we believe that you have violated the law, or if we believe it is necessary to protect the rights, property, and safety of Synthra, the Synthra ecosystem, the public, or others.
...
Synthra does not typically use any cookies. It reserves the ability to use them to affect the availability and functionality of the UI.
...
Synthra does not “sell” personal information to advertise our products to you or otherwise.

Subject to certain limitations, you have the right to (1) request to know more about the categories and specific pieces of personal information we collect, use, and disclose, and sell, (2) request deletion of your personal information, (3) opt out of any “sales” of your personal information that may be occurring, and (4) not be discriminated against for exercising these rights. You may make these requests by emailing us at synthra-swap@gmail.com. If we receive your request from an authorized agent, we may ask for evidence that you have provided such agent with a power of attorney or that the agent otherwise has valid written authority to submit requests to exercise rights on your behalf. If you are an authorized agent seeking to make a request, please contact us.

### **Shine the Light**

Synthra does not share such information with third parties for direct marketing purposes.
...
Synthra does not typically process user personal data. If Synthra processes data, such as a wallet address and certain IP addresses, it will do so in reliance on the following lawful bases:
...
Subject to certain limitations, you have the right to request access to the personal data we hold about you and to receive your data in a portable format, the right to ask that your personal data be corrected or erased, and the right to object to, or request that we restrict, certain processing. Synthra does not typically hold or store such personal data.

## **Contact Us**

If you have any questions about this Privacy Policy, please contact us at synthra-swap@gmail.com.`.replace(
              /[\n\r]/g,
              '\n'
            )}
          />
