...
import { Currency, CurrencyAmount, Price as synthraswapPrice, Rounding, Token } from '@synthra-swap/sdk-core'
...
export function useV3DerivedMintInfo(
  ...
  price?: synthraswapPrice<Token, Token>
  pricesAtTicks: {
    [bound in Bound]?: synthraswapPrice<Token, Token> | undefined
  }
  pricesAtLimit: {
    [bound in Bound]?: synthraswapPrice<Token, Token> | undefined
  }
  ...
  const price: synthraswapPrice<Token, Token> | undefined = useMemo(() => {
