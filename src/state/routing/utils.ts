...
import { isAvalanche, isBsc, isMatic, isUomi, nativeOnChain } from 'constants/tokens'
...
export function currencyAddressForSwapQuote(currency: Currency): string {
  if (currency.isNative) {
    ...
    if (isUomi(currency.chainId)) return SwapRouterNativeAssets.UOMI
    return SwapRouterNativeAssets.UOMI
  }
