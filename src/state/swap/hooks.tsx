...
import { ChainId, Currency, CurrencyAmount, Percent, TradeType } from '@synthra-swap/sdk-core'
  ...
  const onCurrencySelection = useCallback(
    (field: Field, currency: Currency) => {
      dispatch(
        selectCurrency({
          field,
          currencyId: currency.isToken ? currency.address : currency.isNative ? 'UOMI' : '',
        })
      )
    },
    [dispatch]
